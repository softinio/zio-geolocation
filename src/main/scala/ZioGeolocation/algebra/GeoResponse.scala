...
final case class Results(addressComponents: AddressComponents, formattedAddress: String, geometry: Geometry, placeId: String, types: List[String])

final case class GeoResponse(results: Results, status: String)
